...
public:
  Link_array()
    {}
  Link_array (T * const  *start, T *const * end)
    : Array<void*> ((void**)start, (void**)end)
  {
  }
  ...
  /*
    Urg. don't want to deal with constness. Messy declaration.

    (todo: fixthis.)
   */
  T ** unsafe_access_pointer_array () 
  {
    return (T**) Array<void*>::unsafe_access_array ();
  }
  T ** access_pointer_array () const
  {
